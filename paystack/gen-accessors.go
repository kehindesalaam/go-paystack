...
//this file contains some modifications made by Salaam Kehinde
// <kehindesalaam@gmail.com> to adapt it to the Paystack API
package main
...
const source = `// Copyright {{.Year}} The go-paystack AUTHORS. All rights reserved.
//
// Use of this source code is governed by a BSD-style
// license that can be found in the LICENSE file.
